...
#load("dataSCSM.Rdata")
dataDENTRO<-read.xlsx("www/dataDENTRO.xlsx", sheet="data")
interfaceDENTRO<-read.xlsx("www/dataDENTRO.xlsx", sheet="interface")
dataSTA<-read.xlsx("www/dataSTA.xlsx", sheet="data")
interfaceSTA<-read.xlsx("www/dataSTA.xlsx", sheet="interface")
dataDECIDUOUS<-read.xlsx("www/dataDECIDUOUS.xlsx", sheet="data")
interfaceDECIDUOUS<-read.xlsx("www/dataDECIDUOUS.xlsx", sheet="interface")
dataSCSM<-read.xlsx("www/dataSCSM.xlsx", sheet="data")
interfaceSCSM<-read.xlsx("www/dataSCSM.xlsx", sheet="interface")
